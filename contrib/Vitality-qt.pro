...
RESOURCES += src/qt/Vitality.qrc src/qt/Vitality_locale.qrc

TRANSLATIONS += src/qt/locale/Vitality_bg.ts \
                src/qt/locale/Vitality_de.ts \
                src/qt/locale/Vitality_en.ts \
                src/qt/locale/Vitality_es.ts \
                src/qt/locale/Vitality_fi.ts \
                src/qt/locale/Vitality_fr.ts \
                src/qt/locale/Vitality_it.ts \
                src/qt/locale/Vitality_ja.ts \
                src/qt/locale/Vitality_pl.ts \
                src/qt/locale/Vitality_pt.ts \
                src/qt/locale/Vitality_ru.ts \
                src/qt/locale/Vitality_sk.ts \
                src/qt/locale/Vitality_sv.ts \
                src/qt/locale/Vitality_vi.ts \
                src/qt/locale/Vitality_zh_CN.ts \
                src/qt/locale/Vitality_zh_TW.ts
