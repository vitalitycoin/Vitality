...
Vitality now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<Vitality_address\> \<monthly_payment_Vitality\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Vitality, _12_ times over the course of a year totaling _24000_ Vitality.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<Vitality_address\> \<monthly_payment_Vitality\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Vitality.
 ...
 * vote-many          - Vote on a Vitality initiative
 * vote-alias         - Vote on a Vitality initiative
 * vote               - Vote on a Vitality initiative/budget
