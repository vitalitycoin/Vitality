Vitality Core version 2.2.1 is now available from:

  <https://github.com/Vitality-project/Vitality/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/Vitality-project/Vitality/issues>

Compatibility
==============

Vitality Core is extensively tested on multiple operating systems using
...
Vitality Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Vitality was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Vitality-project-translations/).
