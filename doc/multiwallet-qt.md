...
In order to support loading of multiple wallets in Vitality-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Vitality.cpp.
...
Changes to Vitality.cpp
----------------------
Vitality.cpp is the entry point into Vitality-qt, and as such, will require some minor modifications to provide hooks for
