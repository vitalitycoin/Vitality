...
*Setup instructions for a gitian build of Vitality using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Vitality
...
- [Building Vitality](#building-Vitality)
...
Clone the git repositories for Vitality and gitian and then checkout the Vitality version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/Vitality-crypto/Vitality.git
cd Vitality
...
Follow the instructions in [doc/release-process.md](release-process.md) in the Vitality repository
...
To build Vitality (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the Vitality repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/Vitality/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Vitality-crypto/Vitality
...
For example:
```bash
URL=https://github.com/crowning-/Vitality.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit Vitality=${COMMIT} --url Vitality=${URL} ../Vitality/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit Vitality=${COMMIT} --url Vitality=${URL} ../Vitality/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit Vitality=${COMMIT} --url Vitality=${URL} ../Vitality/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/Vitality-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/Vitality-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/Vitality-build.assert
```
...
[Vitality/gitian.sigs](https://github.com/Vitality-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
