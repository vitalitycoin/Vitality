Contributing to Vitality Core
============================

The Vitality Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vitality Core project, and is not to be
confused with overall Vitality Network Protocol consensus changes.

Whether a pull request is merged into Vitality Core rests with the project merge
...
Patches that change Vitality consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vitality consensus, it must have been
...
The project leader is the release manager for each Vitality Core release.
