...
/** Utility functions used by the Vitality Qt UI.
 */
namespace GUIUtil
{
...
// Render Vitality addresses in monospace font
...
// Parse "Vitality:" URI into recipient object, return true on successful parsing
