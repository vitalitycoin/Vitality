...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Vitality Core"),
     ...
     * override -datadir in the Vitality.conf file in the default data directory
     * (to be consistent with Vitalityd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
