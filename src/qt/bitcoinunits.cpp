...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(VIT);
    unitlist.append(mVIT);
    unitlist.append(uVIT);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case VIT:
        return QString("Vitality");
    case mVIT:
        return QString("mVitality");
    case uVIT:
        return QString::fromUtf8("uVitality");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case VIT:
            return QString("VIT");
        case mVIT:
            return QString("Milli-VIT (1 / 1" THIN_SP_UTF8 "000)");
        case uVIT:
            return QString("Micro-VIT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
