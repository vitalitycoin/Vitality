...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Vitality server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Vitality server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vitality features */
        {"Vitality", "masternode", &masternode, true, true, false},
        {"Vitality", "masternodelist", &masternodelist, true, true, false},
        {"Vitality", "mnbudget", &mnbudget, true, true, false},
        {"Vitality", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"Vitality", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Vitality", "mnsync", &mnsync, true, true, false},
        {"Vitality", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"Vitality", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Vitalityd, or the -server option to Vitality-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Vitality-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15414/\n";
}
