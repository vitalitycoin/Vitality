...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vitality Core Vitality-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Vitality-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Vitality transaction") + "\n" +
                               "  Vitality-tx [options] -create [commands]   " + _("Create hex-encoded Vitality transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Vitality transaction
